  ...
  const createAvailability = async (e) => {
    ...
    try {
      ...
      setPendingMeetings((prevMeetings) =>
        prevMeetings.filter((m) => m.id !== currentMeeting.id)
      );
    } catch (error) {
      ...
      >
        {loading ? (
          ...
          <>
            ...
            <p>
              A meeting has been scheduled by your team. In order to find a
              common time that works for everyone, we need you to enter your
              availability for{" "}
              <span className="font-semibold text-primary">
                {formatTime(currentMeeting.datetime, "date")}
              </span>
            </p>
