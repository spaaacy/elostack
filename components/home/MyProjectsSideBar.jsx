...
const MyProjectsSideBar = () => {
  ...
  return (
    <div className="hidden xl:block fixed top-[10%]  max-w-72  rounded-r-lg py-3 bg-white dark:bg-backgrounddark drop-shadow-xl dark:border-r dark:border-y dark:border-gray-400">
