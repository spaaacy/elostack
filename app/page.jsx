...
const Page = () => {
  ...
  return (
    <div className="flex flex-col dark text-white bg-black">
      ...
      <section ref={sectionRef} className="z-10 py-16 sm:py-24 lg:py-36 bg-white text-black">
        <div className="flex flex-col lg:flex-row gap-20 sm:gap-32 lg:gap-44  items-center justify-center w-3/4 text-left mx-auto ">
          <div
            ref={projectRef}
            className="p-2 flex flex-col rounded text-xs font-light tilting gradient-purple text-[#ececec] select-none drop-shadow-3xl max-w-96"
          >
          ...
          <div className="lg:w-1/2">
            ...
            <p>
              EloStack is your hub to discover and venture on new projects in your journey to programming mastery. Built
              with learners in mind, our goal is to build a community around personal projects. Whether you're looking
              to dig into long-term projects or simply work on something on the side, EloStack is there to accomodate
              all your needs. We value real-world experience over raw time spent writing code, and want to best prepare
              you for working in teams. Create great projects and build a better portfolio, and escape the lonesome
              world of personal projects.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="h-[540px] z-10 relative">
        <div className="absolute bg-black h-full w-full opacity-50 -z-10 "></div>

        <Image className="-z-50 object-cover" src={"/wormhole.jpg"} alt="wormhole" fill={true} />
        ...
        >
          <div className="bg-black h-1/3 w-3/4 xl:w-1/2 flex flex-col justify-center items-center py-16  px-8">
            ...
            <Link
              target="_blank"
              href={"/create-project"}
              className="text-center bg-black hover:bg-white border-2 py-2 px-4 text-xl mt-8 hover:text-black  text-white border-white hover:border-transparent transition duration-200 hover:font-semibold"
            >
              Try now
            </Link>
          </div>
      ...
      <section className="py-16 lg:py-24 px-14 bg-gradient-to-bl from-slate-900 to-black relative">
        <div className="absolute bottom-0 left-0 h-1/6 w-full z-40 bg-gradient-to-b  from-transparent to-black"></div>
      ...
      <section className={`px-12 text-center py-16 flex flex-col items-center justify-center ${cormorant.className}`}>
